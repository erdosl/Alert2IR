...
`obs01` is the owned Ubuntu Server 24.04 LTS observability-platform host authorized for future WS12 provisioning and controlled validation. This entry does not broaden authorization beyond that exact host.
