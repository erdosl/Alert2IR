...
2. **02 Windows Endpoint Reproducibility** — repeatable endpoint prerequisites and telemetry configuration.
3. **03 Docker / IR-Core** — minimal application/service composition on the runtime host.
