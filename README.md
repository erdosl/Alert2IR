...
This repository is in its early implementation stage. A minimal typed, in-memory Alert2IR core and FastAPI workflow using the deterministic MockBackend has been validated on `ir-core`. Persistence and real source and investigation integrations remain future work.
